...
public function user_prop_supported_privilege_set() {
  ...
  $write_props = new DAVACL_Element_supported_privilege(DAVACL::PRIV_WRITE_PROPERTIES, true, 'Write properties');
  $write_data  = new DAVACL_Element_supported_privilege(DAVACL::PRIV_WRITE_CONTENT
  $write->add_supported_privilege($write_props);
