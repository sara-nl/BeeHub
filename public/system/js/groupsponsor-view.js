...
(function() { 
 ...
 function handleSubmit(e) {
   ...
   view.controller.changeGroupOrSponsor(decodeURIComponent(location.pathname), displayName, description);
 };
...
//  var button = $('button[type="button"][value="'+user+'"][class="bs-gs-demote-gs"')
 ...
 function createUsageView() { 
   if ($("#bh-dir-loading").css('display') === "none" && ($("#bh-gs-usage-div").html() === undefined || ($("#bh-gs-usage-div").html() === ""))){ 
    ...
    $("#bh-dir-loading").show();
    view.controller.getUsageData(decodeURIComponent(location.href)+"?usage");
   };
 };
