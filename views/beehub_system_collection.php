...
<div class="row-fluid">
  ...
  <div class="span6">
    <h5>Easy sharing of data</h5>
    <p>BeeHub allows you to share your data with other BeeHub users. We have a unique, powerful, fine-grained, yet intuitive and simple way of setting access rights.</p>
  </div>
</div>
<div class="row-fluid">
  <div class="span6">
    <h5>Access from anywhere</h5>
    <p>Your data is online. Your local desktop- or laptop-computer, mobile device or supercomputer doesn’t keep a copy of your data, as with DropBox. Hey, it’s way too much for that anyway, isn’t it?</p>
